                ...
                <div class="property-slide">
                    ...
                    <div class="single-items">
                        <div class="property-listing shadow-none property-2 border">
                            ...
                            <div class="listing-img-wrapper">
                                <div class="_exlio_125">$50620</div>
                                <div class="list-img-slide">
                                    <div class="click">
                            ...
                            <div class="listing-detail-wrapper">
                                <div class="listing-short-detail-wrap">
                                    ...
                                    <div class="listing-short-detail-flex">
                                        <div class="prt_saveed_12lk">
                                            <label class="toggler toggler-danger"><input type="checkbox" checked><i class="fas fa-heart"></i></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="single-items">
                        <div class="property-listing shadow-none property-2 border">
                            ...
                            <div class="listing-img-wrapper">
                                <div class="_exlio_125">$60850</div>
                                <div class="list-img-slide">
                                    <div class="click">
                    ...
                    <div class="single-items">
                        <div class="property-listing shadow-none property-2 border">
                            ...
                            <div class="listing-img-wrapper">
                                <div class="_exlio_125">$40930</div>
                                <div class="list-img-slide">
                                    <div class="click">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="property-listing shadow-none property-2 border">
                    ...
                    <div class="listing-img-wrapper">
                        <div class="list-img-slide">
                            <div class="click">
                                <div><a href="single-property-1.html"><img src="assets/img/p-22.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                                <div><a href="single-property-1.html"><img src="assets/img/p-9.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                                <div><a href="single-property-1.html"><img src="assets/img/p-10.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                            </div>
                        </div>
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="listing-short-detail">
                                ...
                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Sunstone Property Advisors</a></h4>
                    ...
                    <div class="listing-detail-footer align-items-center">
                        <div class="footer-first">
                            <div class="list-fx-features flio-wrap m-0">
                                <div class="listing-card-info-icon">
                                    <div class="inc-fleat-icon"><i class="fa-solid fa-bed theme-cl"></i></div>3 Beds
                                </div>
                                <div class="listing-card-info-icon">
                                    <div class="inc-fleat-icon"><i class="fa-solid fa-bath theme-cl"></i></div>2 Bath
                                </div>
                            </div>
                        </div>
                        <div class="footer-flex">
                            <div class="list-fx-features m-0">
                                <div class="amenties-lists">
                                    <span class="small me-2"><i class="fa-solid fa-fan"></i></span>
                                    <span class="small me-2"><i class="fa-solid fa-dog"></i></span>
                                    <span class="small me-2"><i class="fa-solid fa-smoking"></i></span>
                                    <span class="small me-2"><i class="fa-solid fa-square-parking"></i></span>
                                    <span class="small"><i class="fa-solid fa-bowl-food"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="property-listing shadow-none property-2 border">
                    ...
                    <div class="listing-img-wrapper">
                        <div class="list-img-slide">
                            <div class="click">
                                <div><a href="single-property-1.html"><img src="assets/img/p-20.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                                <div><a href="single-property-1.html"><img src="assets/img/p-9.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                                <div><a href="single-property-1.html"><img src="assets/img/p-10.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                            </div>
                        </div>
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="listing-short-detail">
                                <div class=""><span class="label text-success bg-light-success font-bold py-1 small me-2">Apartment</span><span class="font-bold py-1 label theme-cl bg-light-info small">For Rent</span></div>
                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Platinum Property Advisors</a></h4>
                                <div class="dflio-location"><span class="small"><i class="fa-solid fa-location-dot me-2"></i>210 Zirak Road, Canada</span></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="property-listing shadow-none property-2 border">
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="listing-short-detail">
                                <div class=""><span class="label text-success bg-light-success font-bold py-1 small me-2">Apartment</span><span class="font-bold py-1 label theme-cl bg-light-info small">For Rent</span></div>
                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Equinox Partners Real Property</a></h4>
                                <div class="dflio-location"><span class="small"><i class="fa-solid fa-location-dot me-2"></i>210 Zirak Road, Canada</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="price-features-wrapper d-flex align-items-center justify-content-between">
                        <div class="listing-short-detail-flex">
                            <h6 class="listing-card-info-price ps-0 m-0">$95,800</h6>
                        </div>
                        <div class="listing-short-btns-groups">
                            <a href="JavaScript:Void(0);" class="compare"><i class="fa-solid fa-code-compare"></i></a>
                            <a href="JavaScript:Void(0);" class="message"><i class="fa-solid fa-envelope-open-text"></i></a>
                ...
                <div class="property-listing shadow-none property-2 border">
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="listing-short-detail">
                                <div class=""><span class="label text-success bg-light-success font-bold py-1 small me-2">Apartment</span><span class="font-bold py-1 label theme-cl bg-light-info small">For Rent</span></div>
                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Orchard Street Properties</a></h4>
                                <div class="dflio-location"><span class="small"><i class="fa-solid fa-location-dot me-2"></i>210 Zirak Road, Canada</span></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="property-listing shadow-none property-2 border">
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="listing-short-detail">
                                <div class=""><span class="label text-success bg-light-success font-bold py-1 small me-2">Apartment</span><span class="font-bold py-1 label theme-cl bg-light-info small">For Rent</span></div>
                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Sterling Property Advisors</a></h4>
                                <div class="dflio-location"><span class="small"><i class="fa-solid fa-location-dot me-2"></i>210 Zirak Road, Canada</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="price-features-wrapper d-flex align-items-center justify-content-between">
                        <div class="listing-short-detail-flex">
                            <h6 class="listing-card-info-price ps-0 m-0">$98,500</h6>
                        </div>
                        <div class="listing-short-btns-groups">
                            <a href="JavaScript:Void(0);" class="compare"><i class="fa-solid fa-code-compare"></i></a>
                            <a href="JavaScript:Void(0);" class="message"><i class="fa-solid fa-envelope-open-text"></i></a>
                ...
                <div class="property-listing shadow-none property-2 border">
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="listing-short-detail">
                                <div class=""><span class="label text-success bg-light-success font-bold py-1 small me-2">Apartment</span><span class="font-bold py-1 label theme-cl bg-light-info small">For Rent</span></div>
                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Cobblestone Realty Partners</a></h4>
                                <div class="dflio-location"><span class="small"><i class="fa-solid fa-location-dot me-2"></i>210 Zirak Road, Canada</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="price-features-wrapper d-flex align-items-center justify-content-between">
                        <div class="listing-short-detail-flex">
                            <h6 class="listing-card-info-price ps-0 m-0">$85,700</h6>
                        </div>
                        <div class="listing-short-btns-groups">
                            <a href="JavaScript:Void(0);" class="compare"><i class="fa-solid fa-code-compare"></i></a>
                            <a href="JavaScript:Void(0);" class="message"><i class="fa-solid fa-envelope-open-text"></i></a>
        ...
        <div class="row list-layout">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="property-listing property-1">
                    ...
                    <div class="listing-img-wrapper">
                        <a href="single-property-2.html">
                            <img src="assets/img/p-8.jpg" class="img-fluid mx-auto" alt="" />
                        </a>
                    </div>
...
<section>
    <div class="container">
                ...
                <div class="agents-grid">
                    ...
                    <div class="agents-grid-wrap">
                        ...
                        <div class="fr-grid-deatil">
                            <div class="fr-grid-deatil-flex">
                                ...
                                <span class="agent-property">117 Properties</span>
                            </div>
                    ...
                    <div class="fr-grid-footer">
                        ...
                        <div class="fr-grid-footer-flex-right">
                            <a href="agent-page.html" class="prt-view" tabindex="0">View</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="agents-grid">
                    ...
                    <div class="agents-grid-wrap">
                        ...
                        <div class="fr-grid-deatil">
                            <div class="fr-grid-deatil-flex">
                                <h5 class="fr-can-name"><a href="#">Charles T. Hines</a></h5>
                                <span class="agent-property">302 Properties</span>
                            </div>
                            <div class="fr-grid-deatil-flex-right">
                                <div class="agent-email"><a href="#"><i class="ti-email"></i></a></div>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                <a href="listings-list-with-sidebar.html" class="btn btn-theme-light-2 rounded">Explore More Agents</a>
            </div>
        </div>
